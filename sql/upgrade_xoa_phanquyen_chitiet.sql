...
/* ============================================================
   3. SEED QUYỀN CHI TIẾT THEO HÀNH ĐỘNG CHO TỪNG MODULE NGHIỆP VỤ
      (Thêm / Sửa / Xóa mềm) - mỗi module 1 module_group riêng để
      màn hình Phân quyền tự hiển thị thành từng khối rõ ràng.
      Hệ thống KHÔNG còn hỗ trợ "xóa cứng" (xóa vĩnh viễn) - chỉ
      còn Thêm/Sửa/Xóa mềm.
   ============================================================ */
...
/* ============================================================
   4. SEED PHÂN QUYỀN MẶC ĐỊNH THEO ĐÚNG QUY TẮC NGHIỆP VỤ:
      - Quản trị viên (role_id=4): TẤT CẢ (thêm/sửa/xóa mềm)
      - Giám đốc (role_id=5)     : thêm/sửa/xóa mềm
      ...
      Hệ thống KHÔNG còn quyền "xóa cứng" (xóa vĩnh viễn) ở bất kỳ vai
      trò nào.
   ============================================================ */
...
IF NOT EXISTS (SELECT * FROM RolePermission rp
               ...
               WHERE rp.role_id = 4 AND p.permission_code = 'KHACHHANG_XOAMEM')
BEGIN
...
PRINT N'Đã nâng cấp: cơ chế xóa mềm + phân quyền chi tiết theo hành động.';
