...
<%
    ...
    ArrayList<Receipt> pageList = new ArrayList<Receipt>(Paginator.slice(list, currentPage));
    String pageUrl = Paginator.buildPageUrl(request, request.getContextPath() + "/phieuthu");
%>
