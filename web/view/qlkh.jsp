...
<%
    ...
    ArrayList<Customer> pageList = new ArrayList<Customer>(Paginator.slice(list, currentPage));
    String pageUrl = Paginator.buildPageUrl(request, request.getContextPath() + "/khachhang");
%>
